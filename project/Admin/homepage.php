...
<head>
  ...
  <link rel="shortcut icon" type="image/png" href="../Asset/Templates/Admin/assets/images/logos/seodashlogo.png" />
  <link rel="stylesheet" href="../Asset/Templates/Admin/assets/css/styles.min.css" />
  <link rel="stylesheet" href="../Asset/Templates/form.css">
</head>
      ...
      <div>
        <div class="brand-logo d-flex align-items-center justify-content-between">
          <a href="./index.html" class="text-nowrap logo-img">
            <img src="../Asset/Templates/Admin/assets/images/logos/logo-light.svg" alt="" />
          </a>
        ...
        <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
          <ul id="sidebarnav">
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="Panchayat.php" aria-expanded="false">
                <span>
                  <iconify-icon icon="solar:bookmark-square-minimalistic-bold-duotone" class="fs-6"></iconify-icon>
                </span>
                <span class="hide-menu">Panchayat</span>
              </a>
            </li>
            <li class="sidebar-item">
              <a class="sidebar-link" href="village.php" aria-expanded="false">
                <span>
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="PHClist.php" aria-expanded="false">
                <span>
                  <iconify-icon icon="solar:text-field-focus-bold-duotone" class="fs-6"></iconify-icon>
                </span>
                <span class="hide-menu">PHC</span>
              </a>
            </li>
            <!-- <li class="nav-small-cap"> -->
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="Subcenterlist.php" aria-expanded="false">
                <span>
                  <iconify-icon icon="solar:login-3-bold-duotone" class="fs-6"></iconify-icon>
                </span>
                <span class="hide-menu">Subcenter</span>
              </a>
            </li>
            <li class="sidebar-item">
              <a class="sidebar-link" href="Userlist.php" aria-expanded="false">
                ...
                <span class="hide-menu">Userlist</span>
              </a>
            </li>
            <li class="sidebar-item">
              <a class="sidebar-link" href="UserComplaints.php" aria-expanded="false">
                <span>
                  <iconify-icon icon="solar:user-plus-rounded-bold-duotone" class="fs-6"></iconify-icon>
                </span>
                <span class="hide-menu">UserComplaints</span>
              </a>
            </li>
            <li class="sidebar-item">
      ...
      <!-- <div class="container-fluid">
        ...
        <div class="col-lg-4">
          <div class="card">
            <div class="card-body text-center">
              <img src="../Asset/Templates/Admin/assets/images/backgrounds/product-tip.png" alt="image" class="img-fluid" width="205">
          ...
          <div class="card overflow-hidden hover-img">
            <div class="position-relative">
              <a href="javascript:void(0)">
                <img src="../Asset/Templates/Admin/assets/images/blog/blog-img1.jpg" class="card-img-top" alt="matdash-img">
              </a>
              <span class="badge text-bg-light text-dark fs-2 lh-sm mb-9 me-9 py-1 px-2 fw-semibold position-absolute bottom-0 end-0">2
                min Read</span>
              <img src="../Asset/Templates/Admin/assets/images/profile/user-3.jpg" alt="matdash-img" class="img-fluid rounded-circle position-absolute bottom-0 start-0 mb-n9 ms-9" width="40" height="40" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Georgeanna Ramero">
            </div>
        ...
        <div class="col-lg-4">
          <div class="card overflow-hidden hover-img">
            <div class="position-relative">
              <a href="javascript:void(0)">
                <img src="../Asset/Templates/Admin/assets/images/blog/blog-img2.jpg" class="card-img-top" alt="matdash-img">
              </a>
              <span class="badge text-bg-light text-dark fs-2 lh-sm mb-9 me-9 py-1 px-2 fw-semibold position-absolute bottom-0 end-0">2
                min Read</span>
              <img src="../Asset/Templates/Admin/assets/images/profile/user-2.jpg" alt="matdash-img" class="img-fluid rounded-circle position-absolute bottom-0 start-0 mb-n9 ms-9" width="40" height="40" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Georgeanna Ramero">
            </div>
            <div class="card-body p-4">
        ...
        <div class="col-lg-4">
          <div class="card overflow-hidden hover-img">
            <div class="position-relative">
              <a href="javascript:void(0)">
                <img src="../Asset/Templates/Admin/assets/images/blog/blog-img3.jpg" class="card-img-top" alt="matdash-img">
              </a>
              <span class="badge text-bg-light text-dark fs-2 lh-sm mb-9 me-9 py-1 px-2 fw-semibold position-absolute bottom-0 end-0">2
                min Read</span>
              <img src="../Asset/Templates/Admin/assets/images/profile/user-3.jpg" alt="matdash-img" class="img-fluid rounded-circle position-absolute bottom-0 start-0 mb-n9 ms-9" width="40" height="40" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Georgeanna Ramero">
