...
if (isset($_POST['btnsubmit'])) {
    ...
    // Ensure that 'did' is present in the URL
    if (isset($_GET['did'])) {
        $insqry = "INSERT INTO tbl_scvaccination(vc_date, vc_starttime, vc_endtime, sc_id) 
                   VALUES('" . $Date . "','" . $Start . "','" . $End . "','" . $_GET['did'] . "')";
    ...
    <form id="form1" name="form1" method="post" action="">
        <div class="card mb-4">
            ...
            <div class="card-body">
                ...
                <div class="form-group row">
                    <label for="txtstart" class="col-sm-2 col-form-label">Start Time</label>
                    <div class="col-sm-10">
                        <input type="time" name="txtstart" id="txtstart" class="form-control" required>
                    </div>
                </div>
                <div class="form-group row">
                    <label for="txtend" class="col-sm-2 col-form-label">End Time</label>
                    <div class="col-sm-10">
                        <input type="time" name="txtend" id="txtend" class="form-control" required>
                    </div>
                </div>
                <div class="form-group row">
